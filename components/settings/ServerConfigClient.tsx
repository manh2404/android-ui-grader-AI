...
function Toggle({ checked, onChange, label }: { checked: boolean; onChange: (value: boolean) => void; label: string }) {
    return (
        <button
            ...
            aria-label={label}
            className={`relative h-7 w-12 rounded-full transition ${checked ? "bg-orange-500" : "bg-slate-300"}`}
        >
            <span
            ...
            <main className="flex-1 overflow-y-auto p-8">
                <div className="mx-auto max-w-5xl space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full rounded-2xl border border-slate-200 px-4 py-3 pr-12 outline-none transition focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
                                    />
                                    <button
                                        type="button"
                    ...
                    <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.6fr_1fr]">
                            ...
                            <div className="space-y-6 p-6">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <button
                                        ...
                                        disabled={testing}
                                        className="rounded-2xl border border-orange-200 px-5 py-3 text-sm font-semibold text-orange-600 transition hover:bg-orange-50 disabled:cursor-not-allowed disabled:opacity-70"
                                    >
                        ...
                        <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                            <div className="flex items-center gap-3 border-b border-slate-100 p-6">
                                <span className="material-symbols-outlined text-orange-500">cloud_sync</span>
                    ...
                    <div className="sticky bottom-4 z-20 flex flex-wrap items-center justify-between gap-4 rounded-[24px] border border-slate-200 bg-white/95 p-4 shadow-lg backdrop-blur">
                        ...
                        <button
                            ...
                            onClick={handleSave}
                            disabled={saving}
                            className="rounded-2xl bg-orange-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-orange-200 transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-70"
                        >
