        ...
        <div className="flex h-full min-h-0 flex-col rounded-2xl border border-slate-200 bg-white p-4">
            ...
            <div className="mt-3 grid shrink-0 grid-cols-1 gap-3 md:grid-cols-2">
                <label className="text-sm font-medium text-slate-700">
                    ...
                    <select
                        ...
                        className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100"
                    >
            ...
            <div className="mt-4 flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center">
                <button
                    ...
                    onClick={handleSave}
                    disabled={saving}
                    className="rounded-2xl bg-orange-500 px-6 py-3 text-sm font-bold text-white hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-60"
                >
